...
function Project() {
  ...
  const allProject = [
    ...
    {
      img: 'https://plus.unsplash.com/premium_photo-1701094772081-043554068ae5?q=80&w=1887&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
      id: 2,
      name: 'project 2',
      tech: ['REact ', 'tailwind css', 'jsvascript'],
      title: 'frontend',
