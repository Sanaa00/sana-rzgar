...
function Project() {
  ...
  const allProject = [
    {
      img: 'https://images.unsplash.com/photo-1612179543058-ab74d388e0ce?q=80&w=1887&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
      id: 1,
      name: 'project 1',
