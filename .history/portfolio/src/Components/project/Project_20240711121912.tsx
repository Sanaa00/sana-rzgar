...
function Project() {
  ...
  const allProject = [
    ...
    {
      img: 'https://images.unsplash.com/photo-1543251698-9ef753c40fbc?q=80&w=1887&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
      id: 2,
      name: 'project 2',
      tech: ['REact ', 'tailwind css', 'jsvascript'],
      title: 'frontend',
