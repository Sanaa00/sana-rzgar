...
function Project() {
  ...
  const allProject = [
    {
      img: 'https://plus.unsplash.com/premium_photo-1681412205205-5422a084e717?q=80&w=1887&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
      id: 1,
      name: 'project 1',
