   ...
   const titles = [
    { text: 'Sana Rzgar', delay: 0.5 },
     { text: 'Front-End Developer', delay: 1.5 },
      { text: 'Passionate about crafting seamless and interactive web experiences, Committed to continuous learning and staying ahead in the ever-evolving tech landscape.', delay: 1.5 },
  ];
  return (
